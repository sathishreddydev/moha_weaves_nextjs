...
# Server-side secrets are also needed at build time for NextAuth route
# generation in standalone mode, but they are NOT embedded in client bundles.
...
ENV TWO_FACTOR_API_KEY=$TWO_FACTOR_API_KEY
