          ...
          <div className="flex items-center gap-3">
            {showBackButton && onBack && (
              <Button
                ...
                size="icon"
                onClick={onBack}
                className="h-10 w-10  min-w-[44px] touch-manipulation active:scale-95 transition-transform"
              >
...
export function MobileMenuButton({
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={onClick}
      className="h-12 w-12  min-w-[44px] touch-manipulation active:scale-95 transition-transform lg:hidden"
