...
export default function Addresses() {
  const { addresses, loading, error, fetchAddresses, deleteAddress, setDefaultAddress, updating, createAddress } = useAddressStore()
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-6">
          <div className="text-red-600 text-center">
            ...
            <Button onClick={fetchAddresses} className="mt-2">Retry</Button>
          </div>
        </div>
      </div>
    )
