...
export const orders = pgTable("orders", {
  ...
  autoProcessed: boolean("auto_processed").default(true),
  ...
  autoShippingAttempts: integer("auto_shipping_attempts").default(0),
  lastAutoShippingAttempt: timestamp("last_auto_shipping_attempt"),
  createdAt: timestamp("created_at").notNull().defaultNow(),
  updatedAt: timestamp("updated_at").notNull().defaultNow(),
});
